        ...
        <?php foreach ($users as $list_user): ?>
            <li>
                <div style="width: 100px; overflow-x: hidden;
                    ...
                    padding-top: 4px;">
                    <a href="<?php echo URL::Absolute('admin/user/edit/'
                        . $list_user['user_id']);?>"
                        style="font-size: 1.4em; font-weight: bold;
                        vertical-align: middle;"
                        ><?php echo $list_user['username']; ?></a>
                </div>
                <div style="display: inline-block;">
                    ...
                    <?php 
                    // Don't show actions that a user can't do to
                    // themselves
                        if ($list_user['user_id'] != $user['user_id']): ?>
                        <a href="<?php echo URL::Absolute('admin/user/delete/'
                            . $list_user['user_id']);?>"
                            class="button" style="float: left; width: 100px;">
                            <img src="<?php echo URL::Absolute(
                                'media/img/user-delete.png'); ?>"/>
                            <div>Delete</div>
                        </a>
