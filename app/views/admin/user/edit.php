...
<form action="<?php echo URL::Absolute('admin/user/edit/'
    . $edit_user['user_id'] . '/save'); ?>" method="post" id="edit_form">
    <table>
        <tr>
            <td>Username</td>
            <td>
        ...
        <tr>
            <td>Manage Users</td>
            <td>
                <input type="checkbox" name="permission_manage_users"
                    value="true"
        ...
        <tr>
            <td>Edit Pages</td>
            <td>
                <input type="checkbox" name="permission_pages_edit" value="true"
        ...
        <tr>
            <td>Add Pages</td>
            <td>
                <input type="checkbox" name="permission_pages_add" value="true"
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="permission_blog_entry_edit"
                    value="true"
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="permission_blog_entry_add"
                    value="true"
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" name="permission_blog_entry_credit_users"
                    value="true"
                    <?php if ($edit_user['permission_blog_entry_credit_users']
                              == 1)
                        echo 'checked="checked"';
                    ?>/>
            </td>
