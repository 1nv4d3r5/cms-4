        ...
        <?php foreach ($entries as $list_entry): ?>
            <li>
                ...
                <div style="display: inline-block;">
                    ...
                    <?php endif; ?>
                    <?php if ($list_entry['published']): ?>
                        <a href="<?php echo URL::Absolute('admin/blog/unpublish/' . $list_entry['blog_entry_id']);?>"
                            class="button" style="float: left; width: 115px;">
                            <img src="<?php echo URL::Absolute('media/img/page-unpublish.png'); ?>"/>
                            <div>Unpublish</div>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo URL::Absolute('admin/blog/publish/' . $list_entry['blog_entry_id']);?>"
                            class="button" style="float: left; width: 100px;">
                            <img src="<?php echo URL::Absolute('media/img/page-publish.png'); ?>"/>
                            <div>Publish</div>
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo URL::Absolute('admin/blog/delete/' . $list_entry['blog_entry_id']);?>"
                        class="button" style="float: left; width: 100px;">
